// ============================================================
// data.js - Inlined JSON data for universal file:// compatibility
// This file embeds events.json and event-details.json so the
// site works when opened directly without a web server.
// ============================================================

window.VIHANSA_EVENTS_DATA = {
  "day1": {
    "tech": [
      "Code It gitFull Day)",
      "Ideathon (Paper Presentation)",
      "Clone X",
      "Arkham Encrypted (Mystery Coding)",
      "Reverse Engineering",
      "Circuit Debugging",
      "Capture the Flag",
      "iConfusion (Quiz)"
  ...
  "mainEvents": [
    {
      ...
      "description": "Showcase your technical research and innovative ideas.",
    ...
    },
    {
      "id": "project-expo",
      "title": "Project Expo",
      "description": "Display your working models and prototypes.",
    ...
    },
    {
      "id": "report-rendering",
      "title": "LOGIC RUSH",
      "description": "Evaluate logical reasoning, coding efficiency, and problem-solving.",
...
window.VIHANSA_EVENT_DETAILS = {
  "paper-presentation": {
    "title": "Paper Presentation",
    "desc": "<div class=\"event-full-desc\">\n      <p><strong>Paper Presentation</strong> provides a platform for students to showcase their technical research and innovative ideas. Participants will present their papers on trending technologies and engineering advancements.</p>\n      \n      <h3>📋 Rules</h3>\n      <ul>\n        <li>Maximum 4 members per team.</li>\n        <li>Abstract must be submitted prior to the event.</li>\n        <li>Presentation time: 8-10 minutes.</li>\n        <li>Q&A session will follow the presentation.</li>\n        <li>Hardcopy of the paper is required.</li>\n      </ul>\n\n      <h3>Staff Coordinator</h3>\n      <p><strong>Ms. S Natheldha Mary Navina</strong></p>\n\n      <h3>Student Coordinator</h3>\n      <p><strong>Rajeshwari. V</strong> - <a href=\"tel:+916383530080\" style=\"color: #00f0ff;\">63835 30080</a></p>\n      <p><strong>Rajeswari. R</strong> - <a href=\"tel:+916369689710\" style=\"color: #00f0ff;\">63696 89710</a></p>\n      <p><strong>Abarna. M</strong> - <a href=\"tel:+916380341813\" style=\"color: #00f0ff;\">63803 41813</a></p>\n    </div>",
    "date": "Day 1",
    "time": "10:00 AM",
    "venue": "EG Hall",
    "image": "img/events-main/paper_presentation.webp",
  ...
  "project-expo": {
    "title": "Project Expo",
    "desc": "<div class=\"event-full-desc\">\n      <p><strong>Project Expo</strong> is an exhibition of innovation where students display their working models and prototypes. It is an opportunity to demonstrate practical applications of engineering concepts.</p>\n      \n      <h3>📋 Rules</h3>\n      <ul>\n        <li>Maximum 4 members per team.</li>\n        <li>Working model or prototype is mandatory.</li>\n        <li>Poster presentation is recommended to explain the project.</li>\n        <li>Projects will be judged on innovation, feasibility, and presentation.</li>\n      </ul>\n\n      <h3>Staff Coordinator</h3>\n      <p><strong>Ms. J. Sangeetha Saral</strong></p>\n\n      <h3>Student Coordinator</h3>\n      <p><strong>Harshini. A</strong> - <a href=\"tel:+916385914530\" style=\"color: #00f0ff;\">63859 14530</a></p>\n      <p><strong>Mutharasi R</strong> - <a href=\"tel:+918056516094\" style=\"color: #00f0ff;\">80565 16094</a></p>\n      <p><strong>Subashini B</strong> - <a href=\"tel:+918754211587\" style=\"color: #00f0ff;\">87542 11587</a></p>\n    </div>",
    "date": "Day 2",
    "time": "10:00 AM",
  ...
  "report-rendering": {
    "title": "LOGIC RUSH",
    "desc": "<div class=\"event-full-desc\">\n      <p><strong>LOGIC RUSH</strong> is a competitive technical event crafted to evaluate logical reasoning, coding efficiency, debugging precision, and problem-solving ability under time pressure. The contest blends structured programming challenges with deceptive inputs and hidden twists, pushing participants to think beyond obvious solutions.</p>\n      \n      <h3>💰 Prize Details</h3>\n      <table style=\"width:100%; border-collapse: collapse; margin: 10px 0;\">\n        <tr style=\"background: rgba(0, 240, 255, 0.1);\">\n          <td style=\"font-weight: 700; color: #00f0ff;\">Position</td>\n          <td style=\"font-weight: 700; color: #00f0ff;\">Amount</td>\n        </tr>\n        <tr><td>🥇 1st Prize</td><td><strong>₹3,000</strong></td></tr>\n        <tr><td>🥈 2nd Prize</td><td><strong>₹2,000</strong></td></tr>\n        <tr><td>🥉 3rd Prize</td><td><strong>₹1,000</strong></td></tr>\n      </table>\n\n      <h3>📜 Rules and Details</h3>\n      <ul>\n        <li><strong>Team Size:</strong> 2 - 3 members per team</li>\n        <li>Each team should use only <strong>ONE HackerRank ID</strong> for submissions</li>\n        <li>Any form of plagiarism or unfair activity leads to <strong>disqualification</strong></li>\n        <li>Judges decision will be <strong>final and binding</strong></li>\n        <li>Participants may use any programming language (Java / Python / C++ / C / SQL)</li>\n        <li>Tab switching or external assistance is <strong>not permitted</strong></li>\n        <li>Only shortlisted teams from Round 1 can proceed to Round 2</li>\n        <li><strong>Number of Rounds:</strong> 2</li>\n      </ul>\n\n      <h3>📋 Round 1: Technical Screening</h3>\n      <p><strong>Duration:</strong> 60 Minutes | <strong>Total Marks:</strong> 40</p>\n      <p>A fast-paced elimination round testing core programming knowledge, debugging precision, and structured logical thinking.</p>\n      \n      <table style=\"width:100%; border-collapse: collapse; margin: 10px 0;\">\n        <tr style=\"background: rgba(0, 240, 255, 0.1);\">\n          <td style=\"font-weight: 700; color: #00f0ff;\">Section</td>\n          <td style=\"font-weight: 700; color: #00f0ff;\">Description</td>\n          <td style=\"font-weight: 700; color: #00f0ff;\">Marks</td>\n        </tr>\n        <tr><td>SQL Challenge</td><td>Query writing, joins, grouping, and NULL handling</td><td>10</td></tr>\n        <tr><td>Pointer</td><td>Identify and fix logical or memory errors in code</td><td>10</td></tr>\n        <tr><td>Data Structure</td><td>Stack, Queue, Linked List, or Hashing logic</td><td>10</td></tr>\n        <tr><td>Matrix Logic</td><td>2D traversal, boundary handling, and patterns</td><td>10</td></tr>\n      </table>\n\n      <h3>🔥 Round 2: Final Challenge</h3>\n      <p><strong>Duration:</strong> 90 Minutes | <strong>Total Marks:</strong> 60</p>\n      <p>A high-intensity round where inputs are deceptive and constraints are unpredictable. Every character, space, and condition can alter the result.</p>\n\n      <table style=\"width:100%; border-collapse: collapse; margin: 10px 0;\">\n        <tr style=\"background: rgba(0, 240, 255, 0.1);\">\n          <td style=\"font-weight: 700; color: #00f0ff;\">Section</td>\n          <td style=\"font-weight: 700; color: #00f0ff;\">Description</td>\n          <td style=\"font-weight: 700; color: #00f0ff;\">Marks</td>\n        </tr>\n        <tr><td>ASCII - \"Hidden Echo\"</td><td>Decode numeric patterns with misleading ranges</td><td>20</td></tr>\n        <tr><td>String - \"String Illusion\"</td><td>A twisted string arena filled with spacing traps and logical flips</td><td>20</td></tr>\n        <tr><td>Logic Twist Challenge</td><td>Scenario-based coding problem with a hidden constraint</td><td>20</td></tr>\n      </table>\n\n      <p><em>🎓 All teams completing both rounds will receive a Certificate of Participation.</em></p>\n\n      <h3>Staff Coordinator</h3>\n      <p><strong>Dr. T. C. Ezhil Selvan</strong></p>\n\n      <h3>Student Coordinator</h3>\n      <p><strong>Manisha Sethu</strong> (HEAD) - 3rd Year IT</p>\n      <p><strong>Vaisnavi S</strong> (HEAD) - 3rd Year CSE</p>\n      <p><strong>Akshay Srinivas N</strong> - 2nd Year CSE</p>\n      <p><strong>Priyadharshini T</strong> - 3rd Year IT</p>\n    </div>",
    "date": "Day 1",
    "time": "10:00 AM",
    "venue": "CC1 & CC2 LAB",
    "image": "img/events-main/codeathon.webp",
  ...
  "khokho": {
    "title": "Kho Kho",
    "desc": "<div class=\"event-full-desc\">\n      <p><strong>Kho Kho</strong> is a traditional Indian tag game that requires speed, stamina, and strategy. Teams compete to tag opponents while avoiding being tagged themselves.</p>\n      \n      <h3>📋 Rules</h3>\n      <ul>\n        <li>Each team consists of 12 players (9 on the field, 3 extras).</li>\n        <li>The match consists of two innings.</li>\n        <li>Chasers must sit in squares in the central lane, facing alternate directions.</li>\n        <li>Defenders run in batches of three.</li>\n        <li>Referees decision is final.</li>\n      </ul>\n    </div>",
    "date": "Day 1",
    "time": "10:00 AM",
    "venue": "SRIT Ground",
  ...
  "football": {
    "title": "5s Football",
    "desc": "<div class=\"event-full-desc\">\n      <p><strong>5s Football</strong> is a fast-paced version of football played with 5 players on each side. It demands quick thinking, precise passing, and teamwork.</p>\n      \n      <h3>📋 Rules</h3>\n      <ul>\n        <li>5 players per team (including the goalkeeper).</li>\n        <li>Rolling substitutions are allowed.</li>\n        <li>No offside rule.</li>\n        <li>Match duration: 2 halves of 10-15 minutes (depending on schedule).</li>\n        <li>Referees decision is final.</li>\n      </ul>\n    </div>",
    "date": "Day 1",
    "time": "10:00 AM",
    "venue": "SRIT Ground",
  ...
  "capturetheflag": {
    "title": "Robothon",
    "desc": "<div class=\"event-full-desc\">\n      <p><strong>Robothon</strong> is an intensive robotics competition where teams design, build, and program robots to solve specific challenges within a limited timeframe.</p>\n      \n      <h3>Student Coordinator</h3>\n      <p><strong>Gangaa TM</strong> - <a href=\"tel:+918807305227\" style=\"color: #00f0ff;\">88073 05227</a></p>\n      <h3>Staff Coordinator</h3>\n      <p><strong>Ms. J. Glorypriyadharshini</strong> - <a href=\"tel:+918903612342\" style=\"color: #00f0ff;\">89036 12342</a></p>\n    </div>",
    "date": "Day 1",
    "time": "2:00 PM",
  ...
  "cybersecurity": {
    ...
    "desc": "<div class=\"event-full-desc\">\n      <p><strong>Cyber Security Workshop</strong> dives into the world of digital defense, teaching participants about ethical hacking, network security, and defensive strategies against cyber threats.</p>\n      \n      <h3>Staff Coordinator</h3>\n      <p><strong>Ms. U. Elakkiya</strong> (AP/IT) - <a href=\"tel:+918220890895\" style=\"color: #00f0ff;\">82208 90895</a></p>\n\n      <h3>Student Coordinator</h3>\n      <p><strong>Loganayagi. M</strong></p>\n      <p><strong>Hariharan B</strong> - <a href=\"tel:+919176313101\" style=\"color: #00f0ff;\">91763 13101</a></p>\n    </div>",
    "date": "Day 1",
    "time": "10:00 AM",
    "venue": "Cyber Security Lab",
  ...
  "evehicle": {
    ...
    "desc": "      <p>Explore the future of mobility with hands-on EV tech workshops, live demos, and insights from industry pioneers!</p>\n\n      <h3>Student Coordinator</h3>\n      <p><strong>S.Sudharshun</strong> - <a href=\"tel:+918610846046\" style=\"color: #00f0ff;\">8610846046</a></p>",
    "date": "Day 1",
    "time": "Full Day",
    "venue": "Power Lab",
  ...
  "pcbbuild": {
    "title": "PCB BUILD",
    "desc": "      <p>Learn PCB design fundamentals and assemble your own boards with expert guidance!</p>\n\n      <h3>Student Coordinator</h3>\n      <p><strong>Janani R</strong> - <a href=\"tel:+919345072602\" style=\"color: #00f0ff;\">9345072602</a></p>\n      <h3>Staff Coordinator</h3>\n      <p><strong>Mr. V. Ganesh</strong> - <a href=\"tel:+919384302282\" style=\"color: #00f0ff;\">9384302282</a></p>",
    "date": "Day 2",
    "time": "Full Day",
  ...
  "visualvignetic": {
    ...
    "desc": "<div class=\"event-full-desc\">\n      <p><strong>Short Film</strong> is an offstage event celebrating creativity through visual storytelling. Express your narrative vision through the art of filmmaking.</p>\n      \n      <h3>👥 Participation</h3>\n      <ul>\n        <li><strong>Individual or Team</strong></li>\n        <li><strong>Maximum:</strong> 5 members per team</li>\n      </ul>\n\n      <h3>🕒 Duration</h3>\n      <ul>\n        <li><strong>Minimum:</strong> 5 minutes</li>\n        <li><strong>Maximum:</strong> 15 minutes (including credits)</li>\n      </ul>\n\n      <h3>📜 Rules & Guidelines</h3>\n    <ul>\n        <li>The film must be <strong>original and unpublished</strong></li>\n        <li>Any language is allowed; <strong>subtitles are mandatory</strong> if not in English</li>\n        <li>Films must be submitted in <strong>MP4 format</strong> (minimum 720p resolution)</li>\n        <li>Objectionable or offensive content is <strong>strictly prohibited</strong></li>\n        <li>Overall impact and storytelling will be evaluated</li>\n      </ul>\n\n            <h3>Staff Coordinator</h3>\n      <p><strong>Ms. S. Anne Susan Georgena</strong> - <a href=\"tel:+919655011785\" style=\"color: #00f0ff;\">96550 11785</a></p>\n      <h3>Student Coordinator</h3>\n      <p><strong>Praneeth</strong> - <a href=\"tel:+919363624383\" style=\"color: #00f0ff;\">9363624383</a></p>\n    \n      <h3>Overall Coordinator</h3>\n      <p><strong>Augustin Anandraj</strong> - <a href=\"tel:+917603837611\" style=\"color: #00f0ff;\">76038 37611</a></p>\n      <p><strong>Gokulvanan S</strong> - <a href=\"tel:+919514767841\" style=\"color: #00f0ff;\">95147 67841</a></p>\n    </div>",
    "date": "Day 2",
    "time": "10:00 AM",
    "venue": "Auditorium",
  ...
  "magazine": {
    ...
    "desc": "<div class=\"event-full-desc\">\n      <p>The <strong>Vihansa Magazine</strong> is a collection of literary and artistic works showcasing the talent of SRIT students.</p>\n\n      <h3>Staff Coordinator</h3>\n      <p><strong>Ms. S. Amsaveni</strong></p>\n\n      <h3>Student Coordinator</h3>\n      <p><strong>Dharaneedharan. T</strong></p>\n    </div>",
    "date": "TBD",
    "time": "TBD",
    "venue": "TBD",
    "image": "img/bg_v2.webp",
