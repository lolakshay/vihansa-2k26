...
window.VIHANSA_EVENTS_DATA = {
  ...
  "mainEvents": [
    ...
    },
    {
      "id": "report-rendering",
      "title": "Codeathon",
      "description": "Demonstrate your analytical and problem-solving skills.",
...
window.VIHANSA_EVENT_DETAILS = {
  ...
  "capturetheflag": {
    "title": "robothon",
    "desc": "Capture the Flag (CTF) competition. Find hidden flags in vulnerable systems and prove your hacking skills.      <h3>📞 Contact Information</h3>\n      <p><strong>Student Coordinator:</strong> Gangaa TM - <a href=\"tel:+918807305227\" style=\"color: #00f0ff;\">8807305227</a></p>",
    "date": "Day 1",
    "time": "2:30 PM",
    "venue": "Cyber Security Lab",
